...
public class AMQPConfiguration {
    ...
    @Bean
    public Binding correctAttemptsBinding(final Queue gamificationQueue, final TopicExchange topicExchange) {
        return BindingBuilder.bind(gamificationQueue).to(topicExchange).with("attempt.correct");
    }
